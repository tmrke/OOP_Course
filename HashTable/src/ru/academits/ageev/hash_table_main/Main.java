...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Все ли элементы из \"hashTable2\" присутсвуют в \"hashTable1\"? Ответ: " + hashTable1.containsAll(hashTable2));

        System.out.println("\"hashTable1\" как массив: " + Arrays.toString(hashTable1.toArray(new String[3])));
    }
}